...
Stable shareable release for internal reuse.
...
- Release Type: `Stable Shareable Release`
...
如果你是通过图形界面导入 skill，并提示“缺少 `SKILL.md` 文件”，可以：

- 直接导入当前目录，因为现在已经补了顶层 `SKILL.md`
- 或者改为导入 `skills-bundle/` 里的单个 skill 目录
